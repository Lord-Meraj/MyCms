                ...
                ?>
                        <tr class="Menu-<?php echo htmlentities($result->Id) ?>">
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal<?php echo htmlentities($result->Id) ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="">عنوان</label>
                                                                <input type="text" name="Title" value="<?php echo htmlentities($result->Title) ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="">ترتیب</label>
                                                                <input type="number" name="SortOrder" value="<?php echo htmlentities($result->SortOrder) ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                ...
                                <!-- Modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#remove<?php echo htmlentities($result->Id) ?>">
                                    Remove
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="remove<?php echo htmlentities($result->Id) ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
